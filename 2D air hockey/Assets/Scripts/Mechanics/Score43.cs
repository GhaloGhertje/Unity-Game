...
public class Score43 : MonoBehaviour
{
    ...
    void Hit()
    {
        ...
        {
            Lives--;
            YellowScore.text = Lives.ToString();
        }

        if (Lives == 0)
        {
            Yellow.gameObject.SetActive(false);
            YellowScore.text = "Lost".ToString();
        }

        if (Lives > 0 && BlueScore.text == "Lost" && GreenScore.text == "Lost" && RedScore.text == "Lost")
        {
            WinningScene();
        }
    }
    ...
    void WinningScene()
    {
        YellowScore.text = "Champion".ToString();
